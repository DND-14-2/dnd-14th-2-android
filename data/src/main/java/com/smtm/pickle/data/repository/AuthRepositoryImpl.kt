...
import com.smtm.pickle.data.source.remote.datasource.KakaoAuthDataSource
...
class AuthRepositoryImpl @Inject constructor(
    ...
    /** Kakao 토큰 획득 -> 로그인 */
    override suspend fun loginWithKakao(): Result<AuthToken> =
        kakaoAuthDataSource.getAccessToken().mapCatching { idToken ->
            socialLogin(
                token = idToken,
